...
class Base_ImportImport(models.TransientModel):
    ...
    def _read_file(self, options):
        ...
        if self.file_name:
            ...
            extensions_to_try.append((ext[1:], f"decided from file extension {ext!r}"))
        ...
        for file_extension, guess_message in extensions_to_try:
            ...
            try:
                ...
                requires = str(exc.name_from or exc.name)
                if file_extension == 'xlsx':
                    requires = 'openpyxl or xlrd >= 1.0.0 < 2.0'
                    try:
                        import xlrd  # noqa: PLC0415
                        if parse_version(xlrd.__VERSION__) >= parse_version("2.0"):
                            requires = 'openpyxl'
