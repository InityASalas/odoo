...
describe("Complex html div", () => {
    ...
    const copiedHtmlData = `<ol><li><div>abc</div><div></div></li><li><div></div><div><span>def</span><br><span>ghi</span></div></li></ol>`;
    test("should remove empty <div> elements from pasted content", async () => {
        await testEditor({
            ...
            contentAfter: `<p>12</p><ol><li><div>abc</div></li><li><div>def</div><div>ghi[]</div></li></ol><p>3</p>`,
            config: { baseContainer: "DIV" },
        });
    });
    ...
    test("should remove empty <div> elements from pasted content (2)", async () => {
        await testEditor({
            ...
            contentAfter: `<p>12</p><ol><li><p>abc</p></li><li><p>def</p><p>ghi[]</p></li></ol><p>3</p>`,
        });
    });
});
