...
class TestL10nAccountWithholdingTaxesFlows(TestTaxCommon, AnalyticCommon):
    ...
    def test_withholding_tax_foreign_currency(self):
        ...
        payment_register.withholding_line_ids[0].base_amount = 150.0
        self.assertRecordValues(payment_register.withholding_line_ids, [{
            'original_base_amount': 2000.0,
            'original_tax_amount': 20.0,
            'base_amount': 150.0,
        ...
        payment_register.withholding_line_ids[0].amount = 2.0
        self.assertRecordValues(payment_register, [{
            'amount': 230.0,
            'withholding_net_amount': 218.0,
        }])
    ...
    # TODO: debug the ORM
    # def test_complete_flow_in_form_emulator(self):
    ...
    #             line_form.base_amount = 750.0
    #
    #         lines = payment_register_form.withholding_line_ids._records
    #         self.assertEqual(lines[0]['base_amount'], 300.0)
    #         self.assertEqual(lines[1]['base_amount'], 750.0)
    #
    #         # Change the amount
    #         payment_register_form.amount = 150.0
    #         lines = payment_register_form.withholding_line_ids._records
    #         self.assertEqual(lines[0]['base_amount'], 150.0)
    #         self.assertEqual(lines[1]['base_amount'], 750.0)
    #
    #         # Change the currency
    ...
    #         lines = payment_register_form.withholding_line_ids._records
    #         self.assertEqual(lines[0]['base_amount'], 300.0)
    #         self.assertEqual(lines[1]['base_amount'], 1500.0)
