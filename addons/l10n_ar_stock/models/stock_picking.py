...
class StockPicking(models.Model):
    ...
    l10n_ar_cai_data = fields.Json(string="CAI Data")
    ...
    def l10n_ar_action_create_delivery_guide(self):
        ...
        if not self.l10n_ar_delivery_guide_number:
            ...
            self.l10n_ar_delivery_guide_number = f'{picking_type.l10n_ar_delivery_sequence_prefix}-{picking_type.l10n_ar_sequence_id.next_by_id()}'

        self.l10n_ar_cai_data = {
            'document_type_id': self.picking_type_id.l10n_ar_document_type_id.id,
            'cai_authorization_code': self.picking_type_id.l10n_ar_cai_authorization_code,
            'cai_expiration_date': self.picking_type_id.l10n_ar_cai_expiration_date.strftime('%Y-%m-%d'),
            'sequence_number_start': self.picking_type_id.l10n_ar_sequence_number_start,
            'sequence_number_end': self.picking_type_id.l10n_ar_sequence_number_end,
        }
