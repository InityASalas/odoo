...
class StockPicking(models.Model):
    ...
    l10n_tr_nilvera_dispatch_scenario = fields.Selection(
        ...
        selection=[('TEMELIRSALIYE', _("Basic Dispatch")), ('HALTIPI', _("Wholesale Produce Dispatch"))],
    ...
    l10n_tr_nilvera_dispatch_type = fields.Selection(
        ...
        selection=[('SEVK', _("Online")), ('MATBUDAN', _("Pre-printed"))],
    ...
    def _l10n_tr_validate_edispatch_fields(self):
        ...
        error_messages = partners._l10n_tr_nilvera_validate_partner_details(self.partner_id)
        ...
        invalid_country_drivers = self.env['res.partner']
        invalid_tckn_drivers = self.env['res.partner']
