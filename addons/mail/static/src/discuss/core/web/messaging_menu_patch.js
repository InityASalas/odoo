...
patch(MessagingMenu.prototype, {
    ...
    beforeOpen() {
        ...
        if (!this.store?.MessagingMenuRecordsLoadedState) {
    ...
    channelsContributionCount() {
        ...
        if (
            !this.store?.MessagingMenuRecordsLoadedState &&
        ...
        if (
            ...
            this.store?.initChannelsUnreadCounter != null
        ) {
