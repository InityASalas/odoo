...
class MrpProduction(models.Model):
    ...
    def _compute_picking_ids(self):
        ...
        pickings_per_procurement_group = {
            group_id.id: sorted(picking_ids, reverse=True) for group_id, picking_ids in grouped_stock_pickings
        }
        for order in self:
    ...
    def _action_cancel(self):
        ...
        for production in self:
            ...
            for move_raw_id in production.move_raw_ids.filtered(lambda x: x.state not in ('done', 'cancel')):
