...
class TestMrpProductionBackorder(TestMrpCommon):
    ...
    def test_no_tracking_2(self):
        ...
        self.assertEqual(len(production.group_id.production_ids), 2)

        # Check MO backorder
        mo_backorder = production.group_id.production_ids[-1]
    ...
    def test_tracking_backorder_series_lot_1(self):
        ...
        for i in range(nb_product_todo):
            ...
            if i + 1 != nb_product_todo:  # If last MO, don't make a backorder
                ...
                backorder = Form(self.env['mrp.production.backorder'].with_context(**action['context']))
                backorder.save().action_backorder()
            active_production = active_production.group_id.production_ids[-1]
        ...
        self.assertEqual(len(production.group_id.production_ids), nb_product_todo)
    ...
    def test_tracking_backorder_series_lot_2(self):
        ...
        p2_bo_mls = production.group_id.production_ids[-1].move_raw_ids.filtered(lambda m: m.product_id == p2).move_line_ids
    ...
    def test_rounding_backorder(self):
        ...
        backorder_form = Form(self.env['mrp.production.backorder'].with_context(**action['context']))
        backorder_form.save().action_backorder()
        backorder = production.group_id.production_ids[-1]
    ...
    def test_backorder_name(self):
        def produce_one(mo):
            ...
            backorder = Form(self.env['mrp.production.backorder'].with_context(**action['context']))
            backorder.save().action_backorder()
            return mo.group_id.production_ids[-1]
    ...
    def test_backorder_name_without_procurement_group(self):
        ...
        # The pg is back
        self.assertTrue(production.group_id)
        backorder_ids = production.group_id.production_ids[1]
    ...
    def test_split_draft(self):
        ...
        self.assertEqual(len(mo.group_id.production_ids), 2)

        mo1 = mo.group_id.production_ids[0]
        mo2 = mo.group_id.production_ids[1]
    ...
    def test_split_merge(self):
        ...
        # Should have 3 mos
        self.assertEqual(len(mo.group_id.production_ids), 3)
        mo1 = mo.group_id.production_ids[0]
        mo2 = mo.group_id.production_ids[1]
        mo3 = mo.group_id.production_ids[2]
        # Check quantities
    ...
    def test_split_mo(self):
        ...
        self.assertEqual(len(mo.group_id.production_ids), 10)
    ...
    def test_split_mo_partially_available(self):
        ...
        self.assertEqual(len(mo.group_id.production_ids), 10)
        last_move = mo.group_id.production_ids[-1].move_raw_ids.filtered(lambda m: m.product_id == product_to_use_2)
    ...
    def test_auto_generate_backorder(self):
        ...
        backorder = mo.group_id.production_ids - mo
    ...
    def test_generate_backorder_multi_type(self):
        ...
        bo = mo_always.group_id.production_ids - mo_always
        bo2 = mo_ask.group_id.production_ids - mo_ask
        ...
        self.assertRecordValues(mo_ask, [{'state': 'done', 'qty_produced': qty_produced, 'mrp_production_backorder_count': 2, 'priority': '0'}])
        self.assertRecordValues(mo_never, [{'state': 'done', 'qty_produced': qty_produced, 'mrp_production_backorder_count': 1, 'priority': '0'}])
        bo = mo_ask.group_id.production_ids - mo_ask
        self.assertEqual(bo.product_qty, product_qty - qty_produced)
...
class TestMrpWorkorderBackorder(TransactionCase):
    ...
    def test_mrp_backorder_operations(self):
        ...
        bo_1 = mo.group_id.production_ids - mo
        ...
        bo_2 = mo.group_id.production_ids - mo - bo_1
