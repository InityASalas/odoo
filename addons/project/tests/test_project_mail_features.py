...
class TestProjectMailFeatures(TestProjectCommon, MailCommon):
    ...
    def test_task_portal_share_adds_followers(self):
        ...
        # Verify initial state - our portal user's partner should not be a follower
        ...
        # Create and execute portal share wizard
        ...
        # Check that portal partner has been added as a follower
