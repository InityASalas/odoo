...
class ResourceResource(models.Model):
    ...
    def _is_fully_flexible(self):
        ...
        self.ensure_one()
        return not self.calendar_id or (self.calendar_id and self.calendar_id.schedule_type == 'fully_flexible')
    ...
    def _is_fixed_time(self):
        """ An employee is considered fixed time if the field flexible_hours is False on the calendar
            and the employee is assigned a calendar.
        """
        self.ensure_one()
        return self.calendar_id and self.calendar_id.schedule_type == 'fixed_time'
