...
class TestTaxesDownPaymentSale(TestTaxCommonSale, TestTaxesDownPayment):
    ...
    def setUpClass(cls):
        ...
        cls.company_data['company'].property_account_downpayment_categ_id = cls.env['account.account'].create({
    ...
    def test_down_payment_invoice_multiple_taxes_and_accounts(self):
        ...
        account_id = dp_invoice.company_id.property_account_downpayment_categ_id.id
    ...
    def test_downpayment_invoice_lines_with_down_payment_account(self):
        ...
        self.assertEqual(invoice.invoice_line_ids.account_id.id, self.company_data['company'].property_account_downpayment_categ_id.id)
