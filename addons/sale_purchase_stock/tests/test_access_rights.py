...
class TestAccessRights(TestCommonSalePurchaseNoChart):
    ...
    def test_sales_user_can_access_forecast_report(self):
        ...
        # A PO provides a source document to test if it can be accessed in the forecast report.
        ...
        # The sales user cannot access the PO directly, despite viewing it's info in the report
