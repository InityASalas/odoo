...
class TestStockMove(TestStockCommon):
    ...
    def test_putaway_with_storage_category_1(self):
        ...
        self.env['stock.quant']._update_available_quantity(self.product, self.shelf_1, 1.0)
    ...
    def test_edit_reserved_move_line_1(self):
        ...
        """
        self.env['stock.quant']._update_available_quantity(self.product, self.shelf_1, 1.0)
        self.env['stock.quant']._update_available_quantity(self.product, self.shelf_2, 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_1), 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_2), 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.stock_location), 2.0)
        ...
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_1), 0.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_2), 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.stock_location), 1.0)
        ...
        self.assertEqual(move1.quantity, 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_1), 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_2), 0.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.stock_location), 1.0)
    ...
    def test_edit_reserved_move_line_6(self):
        ...
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.stock_location), 0.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_1), 1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_2, allow_negative=True), -1.0)
    ...
    def test_edit_done_move_line_8(self):
        ...
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_1), 0.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.shelf_1, allow_negative=True), -1.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.stock_location), 0.0)
        self.assertEqual(self.env['stock.quant']._get_available_quantity(self.product, self.stock_location, allow_negative=True), -1.0)
    ...
    def test_scrap_12_qty_in_sublocation(self):
        ...
        self.env['stock.quant']._update_available_quantity(self.product, self.shelf_1, 10)
    ...
    def test_move_line_aggregated_product_quantities(self):
        ...
        first_backorder.action_confirm()
        ...
        second_backorder.action_confirm()
