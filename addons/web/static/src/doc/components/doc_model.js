...
export class DocModel extends Component {
    static template = xml`
        ...
        <aside class="o-doc-model-aside block position-sticky h-100 bg-0 overflow-auto pt-2 pb-2 ps-3 pe-3 border-left">
            <div
            ...
            <t t-if="this.state.showModulesFilter">
                ...
                >
                    ...
                    <label t-att-for="module" t-out="module" t-on-click.prevent=""></label>
                </div>
            </t>
