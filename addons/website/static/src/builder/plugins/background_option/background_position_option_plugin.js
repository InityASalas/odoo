...
class BackgroundPositionOptionPlugin extends Plugin {
    ...
    resources = {
        builder_actions: {
            backgroundType: new BackgroundTypeAction(this),
            setBackgroundSize: new SetBackgroundSizeAction(this),
            backgroundPositionOverlay: new BackgroundPositionOverlayAction(this),
        },
    };
}
