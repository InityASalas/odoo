...
class LayoutOptionPlugin extends Plugin {
    ...
    resources = {
        ...
        builder_actions: {
            setGridLayout: new SetGridLayoutAction(this),
            setColumnLayout: new SetColumnLayoutAction(this),
            changeColumnCount: new ChangeColumnCountAction(this),
        },
    };
    onCloned({ cloneEl }) {
...
class ChangeColumnCountAction extends BuilderAction {
    apply({ editingElement, value: nbColumns }) {
        ...
        if (!rowEl) {
            ...
            prevNbColumns = getNbColumns(columnEls, isMobileView(this.plugin.editable));
        }
    ...
    isApplied({ editingElement, value }) {
        ...
        return getNbColumns(columnEls, isMobileView(this.plugin.editable)) === value;
    }
    /**
    ...
    _resizeColumns(columnEls, nbColumns) {
        const isMobile = isMobileView(this.plugin.editable);
