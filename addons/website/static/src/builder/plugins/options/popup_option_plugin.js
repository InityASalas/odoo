...
class PopupOptionPlugin extends Plugin {
    ...
    resources = {
        ...
        builder_actions: {
            ...
            // current page only.
            moveBlock: new MoveBlockAction(this),
            setBackdrop: new SetBackdropAction(this),
            copyAnchor: new CopyAnchorAction(this),
            setPopupDelay: new SetPopupDelayAction(this),
        },
...
class MoveBlockAction extends BuilderAction {
    ...
    apply({ editingElement, value }) {
        ...
        const whereEl = this.plugin.editable.querySelector(selector);
