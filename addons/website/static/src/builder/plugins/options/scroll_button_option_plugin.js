...
class ScrollButtonOptionPlugin extends Plugin {
    ...
    scrollButtonManager = new ScrollButtonManager();
    resources = {
        builder_options: [
        ...
        builder_actions: {
            addScrollButton: new AddScrollButtonAction(this),
            scrollButtonSectionHeightClassAction: new ScrollButtonSectionHeightClassAction(this),
        },
    };
}
...
class AddScrollButtonAction extends BuilderAction {
    setup() {
        this.manager = this.plugin.scrollButtonManager;
    }
