...
class RatingOptionPlugin extends Plugin {
    ...
    resources = {
        ...
        builder_actions: {
            setIcons: new SetIconsAction(this),
            customIcon: new CustomIconAction(this),
            activeIconsNumber: new ActiveIconsNumberAction(this),
            totalIconsNumber: new TotalIconsNumberAction(this),
        },
    };
}
