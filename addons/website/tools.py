...
def MockRequest(
    ...
    if country_code or city_name:
        try:
            request.geoip._city_record = odoo.http.geoip2.models.City(['en'], country={'iso_code': country_code}, city={'names': {'en': city_name}})
        except TypeError:
            request.geoip._city_record = odoo.http.geoip2.models.City({'country': {'iso_code': country_code}, 'city': {'names': {'en': city_name}}})
