...
class WebsiteSale(payment_portal.PaymentPortal):
    ...
    @route(
        '/shop/checkout', type='http', methods=['GET'], auth='public', website=True, sitemap=False, list_as_website_content=True
    )
    ...
    @route(['/shop/extra_info'], type='http', auth="public", website=True, sitemap=False, list_as_website_content=True)
    ...
    @route('/shop/payment', type='http', auth='public', website=True, sitemap=False, list_as_website_content=True)
    ...
    @route(['/shop/confirmation'], type='http', auth="public", website=True, sitemap=False, list_as_website_content=True)
