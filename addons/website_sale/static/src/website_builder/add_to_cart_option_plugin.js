...
class AddToCartOptionPlugin extends Plugin {
    ...
    resources = {
        ...
        builder_actions: {
            productToCartAction: new ProductToCartAction(this),
            variantToCartAction: new VariantToCartAction(this),
            addToCartAction: new AddToCartAction(this),
        },
    };
...
class ProductToCartAction extends BuilderAction {
    apply({ editingElement, value }) {
        ...
        if (!oneVariant) {
            this.plugin.resetDefaultAction(editingElement);
        }
    }
