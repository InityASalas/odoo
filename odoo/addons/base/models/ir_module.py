...
class IrModuleModule(models.Model):
    ...
    def get_module_info(cls, name):
        if isinstance(name, str):
            ...
            return modules.Manifest.get_module(name, downloaded=True, display_warning=False) or {}
    ...
    def _get_icon_image(self):
        ...
        for module in self:
            ...
            if module.icon:
                ...
                path = Manifest.get_module('base').icon
    ...
    def check_external_dependencies(self, module_name, newstate='to install'):
        try:
            module = modules.Manifest.get_module(module_name)
            module.check_manifest_dependencies()
    ...
    def update_list(self):
        ...
        for manifest in modules.Manifest.list_modules():
    ...
    def _load_module_terms(self, modules, langs, overwrite=False, imported_module=False):
        ...
        for module_name in modules:
            ...
            if not imported_module and not Manifest.get_module(module_name, display_warning=False):
                continue
            for lang in langs:
