...
class TestAddonsFileAccess(BaseCase):
    ...
    def assertCannotAccess(self, path, ExceptionType=OSError, filter_ext=None, exist_ok=True):
        with self.assertRaises(ExceptionType):
            file_path(path, filter_ext=filter_ext, exist_ok=exist_ok)
    ...
    def test_file_path(self):
        ...
        self.assertTrue(file_path(config.root_path + '/__inexisting', exist_ok=False))
        self.assertTrue(file_path('base/__inexisting_file', exist_ok=False))
