...
class Cloc(object):
    ...
    def count_modules(self, env):
        ...
        exclude_path = {
            ...
            if (m := odoo.modules.Manifest.get_module(name, display_warning=False))
        }
        ...
        for module_name in module_list:
            module = odoo.modules.Manifest.get_module(module_name)
            if module and module.addons_path not in exclude_path:
                self.count_path(module.path)
